...
public readonly struct DirectoryMoveAction(DirectoryInfo source, DirectoryInfo destination) : IAction
{
    public IEnumerable<IAction> Execute()
    {
        ...
        foreach (var dir in source.EnumerateDirectories())
        {
            ...
            yield return new DirectoryMoveAction(dir, destinationDirInfo);
        }
        ...
        foreach (var file in source.EnumerateFiles())
        {
            ...
            yield return new FileMoveAction(file, destinationFileInfo);
        }
